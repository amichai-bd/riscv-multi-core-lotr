...
gcc -S -ffreestanding -march=rv32i $1.c -o $1_rv32i.c.s
 #link new ams file with gpc initializer and creates elf file
echo "ABD Linker with RV32i"
gcc  -O3  -march=rv32i -T./gpc_link.common.ld -nostartfiles -D__riscv__ $1_rv32i.c.s ./crt0_gpc.S -o $1_rv32i.elf
#creates readable elf file
objdump -gd $1_rv32i.elf > $1_rv32i_elf_txt.txt
#creates the instruction file 
objcopy --srec-len 1 --output-target=verilog $1_rv32i.elf $1_inst_mem_rv32i.sv 
