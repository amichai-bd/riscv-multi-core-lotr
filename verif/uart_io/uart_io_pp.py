...
base_path = "target/uart_io/tests"

# Construct the paths to the two files to compare
file1_path = os.path.join(base_path, args.test_name, "uart_trk.log").replace("\\", "/")
file2_path = os.path.join("verif", "uart_io", "golden_trk" , "golden_" + args.test_name + "_uart_trk.log").replace("\\", "/")
